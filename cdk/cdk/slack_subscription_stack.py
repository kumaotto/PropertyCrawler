...
class SlackSubscriptionStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        # Lambda Layer
        module_layer = _lambda.LayerVersion(
            self, 'SlackModuleLayer',
            code=_lambda.Code.from_asset('./lambda/layer/modules_layer'),
